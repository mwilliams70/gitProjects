...
public class MemoryGame {
    public static void main(String[] args) {
        ...
        while (!finished) {
            ...
            try {
                System.out.print("Enter Position 1 (Row Column): ");
                int input1 = sc.nextInt();
                int input2 = sc.nextInt();

                // System.out.println("\n");
                System.out.print("\nEnter Position 2 (Row Column): ");
                ...
                System.out.println("Rows: Enter a number between 0 and " +  rows);
                System.out.println("Columns: Enter a number between 0 and " + cols);
            } catch (InputMismatchException e) {
               
                System.out.println("Please enter numbers as coordinates!");
                sc.nextLine();
